...
class _EditProfileState extends State<EditProfile> {
  ...
  //         _authController.signUpModel!.user!.name ?? "";
  //     genderextEditingController.text =
  //         _authController.signUpModel!.user!.gender ?? "";
  //     mobiletextEditingController.text =
  //         _authController.signUpModel!.user!.mobile ?? "";
  //     emailtextEditingController.text =
  //         _authController.signUpModel!.user!.email ?? "";
  //     // birthtextEditingController.text =
  //     //     _authController.mUserdata!.data!.dateOfBirth!.toString();
  //     // _selectedDate = DateTime.parse(
  //     //     _authController.mUserProfile!.user!.birthday!.toString());
  //     citytextEditingController.text =
  //         _authController.signUpModel!.user!.city ?? "";
  //     genderDropdownvalue = genderItems.firstWhere(
  //         (test) =>
  //             test.toLowerCase() ==
  //             _authController.signUpModel!.user!.gender!.toLowerCase(),
  //         orElse: () => genderItems.first);
  //     birthtextEditingController
  //       ..text = _authController.signUpModel!.user!.birthday!
  //           .toString()
  //           .split("T")
  //           .first
  //       ..selection = TextSelection.fromPosition(TextPosition(
  //           offset: birthtextEditingController.text.length,
  //           affinity: TextAffinity.upstream));
  //     _selectedDate = DateTime.parse(
  //         _authController.signUpModel!.user!.birthday!.toString());
  //   });
  // }
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              // Obx(() {
              //   if (_authController.isVerifyOtpLoding.value) {
              //     return const Center(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: !isEdited
                                    ? TextFormField(
                                        enabled: false,
                                        controller: genderextEditingController,
                                        style: const TextStyle(
                                          fontFamily: productSans,
                                          color: white,
                                        ),
